...
By this point we have demonstrated how our package performs sparse group lasso, and that it is much faster than the competing package \pkg{SGL}. In this last section before the conclusion, we utilize the \pkg{sparsegl} package to analyze a real-world data set, concerning genetic markers for breast cancer survival time.

The dimensions of the data are as follows: the design matrix is $ 240\times 7399$, that is, $240$ observations and $7399$ variables. The variables are 
